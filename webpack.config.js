...
const plugins = [
    ...
    new HtmlWebpackPlugin({
        ...
        // Injecting the scripts into the head isn't possible with the demo server because webpack
        // will hilariously load the scripts before the rest of the html body is generated by this
        // plugin, causing React to fail when trying to find a DOM container to render into.
        inject: PRODUCTION ? 'head' : 'body',
